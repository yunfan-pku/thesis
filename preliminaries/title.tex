...
\title{\bf The vapor-liquid equilibrium phases change model accelerated using \textit{in situ} adaptive tabulation}

%The vapor-liquid equilibrium phases change model accelerated using ISAT and ISAT optimization
%Transcritical flow simulation using vapor-liquid equilibrium phases change model and phase simualtion
